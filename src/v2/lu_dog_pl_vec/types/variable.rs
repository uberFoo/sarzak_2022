...
use crate::v2::lu_dog_pl_vec::types::local_variable::LocalVariable;
...
impl Variable {
    ...
    pub fn new_lambda_parameter(
        ...
        store.inter_variable(|id| {
            Arc::new(RwLock::new(Variable {
                name: name.to_owned(),
                subtype: VariableEnum::LambdaParameter(subtype.read().id), // b
                id,
            }))
        })
    }
    ...
    pub fn new_local_variable(
        ...
        store.inter_variable(|id| {
            Arc::new(RwLock::new(Variable {
                name: name.to_owned(),
                subtype: VariableEnum::LocalVariable(subtype.read().id), // b
                id,
            }))
        })
    }
    ...
    pub fn new_parameter(
        ...
        store.inter_variable(|id| {
            Arc::new(RwLock::new(Variable {
                name: name.to_owned(),
                subtype: VariableEnum::Parameter(subtype.read().id), // b
                id,
            }))
        })
    }
