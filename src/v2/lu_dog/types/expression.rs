...
use crate::v2::lu_dog::types::halt_and_catch_fire::HaltAndCatchFire;
...
impl Expression {
    ...
    pub fn r118_map_element<'a>(&'a self, store: &'a LuDogStore) -> Vec<Rc<RefCell<MapElement>>> {
        store
            .iter_map_element()
    ...
    pub fn r116_map_element<'a>(&'a self, store: &'a LuDogStore) -> Vec<Rc<RefCell<MapElement>>> {
        store
            .iter_map_element()
